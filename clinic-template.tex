...
\documentclass[replace-with-department-code]{hmcclinic}
...
%% For your final report, all you need is the department
%% document-class option.


%% For your Statement of Work/proposal and midyear reports or
%% updates, you also need to specify the type of document you're
%% creating.
%%
%% For your Statement of Work, use "proposal"; for example,
%%
%%    \documentclass[department,proposal]{hmcclinic}
%%
%% For midyear reports, use "midyearreport" for a book-like
%% "Midyear Report" or "midyearupdate" for a shorter "Midyear
%% Update" document.
%%
%%    \documentclass[department,midyearreport]{hmcclinic}
%%
%% or
%%
%%    \documentclass[department,midyearupdate]{hmcclinic}
...
\sponsor{Nicest Kind, LLC}

%% What is the title of your report?
\title{Obliterating the Moon: A Nuanced Approach}
...
%%% The abstract environment is not used in shorter documents,
%%% such as a Statement of Work or Midyear Update, so comment it
%%% out for those documents.
\begin{abstract}
...
%%% The acknowledgments environment is not used in shorter
%%% documents, such as a Statement of Work or Midyear Update, so
%%% comment it out for those documents.
