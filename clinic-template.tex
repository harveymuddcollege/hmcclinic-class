...
%% In addition, use ``proposal'' as a document-class option for
%% typesetting Statements of Work; for example,
%%
%%    \documentclass[department,proposal]{hmcclinic}
%%
%% and ``midyear'' for midyear (end of fall semester) Clinic
%% reports; for example
%%
%%    \documentclass[department,midyear]{hmcclinic}

%% For your final report, of course, just include the department
